...
<template>
    <div>
        <h1 id="contactMe" style="clear: both;">
            Contact Me
        </h1>
        <p>
        ...
        <form method="POST" action="https://formspree.io/f/mbjbbleo"
            style="padding-bottom: 5vh; margin-bottom: 5vh">
            <div>
                <ul style="list-style-type: none; padding-left: 0; ">
                    <li style="float: left; margin-right: 10%; width: 15em">
                        <label for="name" style="width: 100%">Name</label>
                        <input type="text" name="name" id="name"
                            style="height: 2em; width: 100%; display: block;" />
                    </li>
                ...
                <div style="clear: both;">
                    ...
                    <textarea type="text" name="message" id="message"
                        style="height: 20em; width: 100%; resize: none"></textarea>
                </div>
            </div>
            <br>
            <button type="submit" id="submitButton" class="button"><b>Send Message</b></button>
        </form>
    </div>
</template>
